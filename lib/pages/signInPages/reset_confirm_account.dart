...
class ResetConfirmAccountPage extends StatefulWidget {
  final email;

  const ResetConfirmAccountPage({Key key, this.email}) : super(key: key);

  @override
  _ResetConfirmAccountPageState createState() => _ResetConfirmAccountPageState();
}

class _ResetConfirmAccountPageState extends State<ResetConfirmAccountPage> {
                      ...
                      Container(
                        ...
                        child: Text.rich(
                          TextSpan(
                              children: <TextSpan>[
                                TextSpan(
                                  text: 'To continue with the password reset, look for a password reset email sent to ',
                                  style: TextStyle(
                                      color: themeColor,
  ...
  void openEmailApp() async {
    try{
      ...
      // print("err====");
      // await launch("message://").catchError((err){
      //     ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      //         content: Text("App Email not found!")
      //     ));
      //     print("err====$err");
