...
class ImageNetworkViewScreen extends StatefulWidget {
  final imageFile;
  final noteImagePath;

  const ImageNetworkViewScreen({Key key, this.imageFile, this.noteImagePath}) : super(key: key);

  @override
  _ImageNetworkViewScreenState createState() => _ImageNetworkViewScreenState();
}

class _ImageNetworkViewScreenState extends State<ImageNetworkViewScreen> {
  String imageFile;
