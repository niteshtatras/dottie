...
class OpenCameraWidget extends StatefulWidget {
  OpenCameraWidget(
    {
      this.onGalleryClick,
      this.onCameraClick,
  ...
  @override
  _OpenCameraWidgetState createState() => _OpenCameraWidgetState();
}

class _OpenCameraWidgetState extends State<OpenCameraWidget> {
