...
class SignUpConductingPoolPage extends StatefulWidget {
  @override
  _SignUpConductingPoolPageState createState() => _SignUpConductingPoolPageState();
}

class _SignUpConductingPoolPageState extends State<SignUpConductingPoolPage> {
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                child:  Image.asset(
                                  index == 0 ? 'assets/boarding/ic_pen_paper'
                                      : index == 1 ? 'assets/boarding/ic_mobile'
                                      : index == 1 ? 'assets/boarding/ic_laptop'
                                      : 'assets/boarding/ic_other_not_listed',
                                  width: 24.0,
                                  height: 24.0,
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  child: Text(
                                    index == 0 ? 'Pen, paper, & clipboard'
                                        : index == 1 ? 'On a laptop'
                                        : index == 2 ? 'Using my phone'
                                        : 'Other, not listed',
                                    style: TextStyle(
                                        color: AppColor.TYPE_PRIMARY,
  ...
  void updateQuestion() async {
    ...
    var simpleListId = "${selectedIndex+242}";
